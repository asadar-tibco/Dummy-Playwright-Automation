...
test.describe('Smoke Tests', () => {
  ...
  test('Smoke Test 1 - Login Functionality Check', async ({ page }) => {
    await test.step('Start login functionality verification', async () => {
  ...
  test('Smoke Test 2 - Homepage Loading Verification', async ({ page }) => {
    await test.step('Verify homepage loading performance', async () => {
  ...
  test('Smoke Test 3 - Navigation Menu Check', async ({ page }) => {
    await test.step('Validate navigation menu elements', async () => {
  ...
  test('Smoke Test 5 - User Profile Access Check', async ({ page }) => {
    await test.step('Verify user profile access', async () => {
